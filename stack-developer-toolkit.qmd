...
Mailing lists are another more old-fashioned form to discuss things. They do not require a special client, but just an email address to subscribe to their regular updates. If you intend to avoid social media, as well as signing up at knowledge sharing platforms such as [stackoverflow.com](https://stackoverflow.com) or [reddit](https://reddit.com) mailing lists are a good way to get help from experienced developers. 

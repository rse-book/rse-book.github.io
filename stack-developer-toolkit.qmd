...
R and Python are the most popular [OSS](#glossary) choices for hacking with data, Julia [@julia] is an up and coming, performance focused language with a much slimmer ecosystem. A bit of JavaScript can't hurt for advanced customization of graphics and online communication of your results.

...
Start to document functions and their parameters using [Roxygen [@roxygen] syntax, and you're already very close to creating your first package. **Pro-tipp**: Hit Cmd+Alt+Shift+R^[On Windows / Linux use Ctrl instead of Cmd.] while inside a function definition with your cursor. When working with R Studio, it will create a nifty roxygen skeleton with all your function's parameters. 

...
![R: "Dplyr smokes pandas." Python: "But Keras is better for ML!" Language wars can be entertaining, sometimes spectacular, but are essentially just useless. (Source: own illustration).](images/languagewar.jpg)

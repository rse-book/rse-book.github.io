...
::: {.callout-note} 
Use commit messages like 'added join toSQL\index{SQL}query, closes #3'. The key word 'closes' or 'fixes', will automatically close issues referred to when merged into the main branch.
:::

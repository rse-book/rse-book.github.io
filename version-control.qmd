...
![GitHub\index{GitHub} Pull Request dialog: Select the *Pull Request*; choose which branch you merge into which target branch. (Source: own GitHub repository.)](images/pr.png)
...
::: {.callout-note} 
Use commit messages like 'added join to SQL\index{SQL}query, closes #3'. The key word 'closes' or 'fixes', will automatically close issues referred to when merged into the main branch.
:::

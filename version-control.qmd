...
![Ouch! We created a conflict by editing the same line in the same file on different branches and trying to, but these branches back together. (source: screenshot own GitHub repository.)](images/merge_conflict.png)

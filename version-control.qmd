...
In this chapter about the way developers work and collaborate, I will stick to version control with *git*. The stack\index{stack} discussion of the previous chapter features a few more version control systems, but given git's dominant position, we will stick solely to git in this introduction to version control.  

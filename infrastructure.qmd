...
*Dockerfile*s are text file recipes to create images, i.e., blueprints for containers. On Windows and OSX we can use Docker Desktop as a docker runtime environment to help us execute basic commands and build images. 

...
Albeit plots may look similar, there is quite an implementation difference between plots optimized for online use and traditional printed figures. Obviously, the beholder cannot interactively adjust parameters in printed images while online visualisation can be very interactive. 

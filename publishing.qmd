...
The Go based [hugo](https://gohugo.io/) or the established classic [Jekyll](https://jekyllrb.com/) are popular static website generator approaches to run a website or blog.

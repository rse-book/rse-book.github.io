...
The Go based Hugo^[https://gohugo.io/]\index{Hugo} or the classic Jekyll^[https://jekyllrb.com/]\index{Jekyll} are popular static website generator approaches to run a website or blog.

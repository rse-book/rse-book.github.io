...
Also, automation\index{automation} is key to the DevOps approach and an important reason why DevOps thinking is also very well suited for academic researchers and business analysts.
...
*Research Software Engineering* willingly accepts to be overwhelming at times. Given the variety of topics touched on in an effort to show the big picture\{big picture}, I encourage the reader to remain relaxed about a few blanks even when it comes to fundamentals.

...
Consider the following simple R wrapper that downloads both data and metadata first and then reads the into R^[Full url of the below code example: https://raw.githubusercontent.com/swissdata/demo/master/data]. (Alternatively, direct streaming would be possible, too.)

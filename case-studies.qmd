...
### GitHub\index{GitHub} to Serve Static Files
...
## Automate Script Execution: An Example with GitHub\index{GitHub} Actions
...
Under-the-hood-work that is traditionally implemented in languages like Java, Python or PHP^[Yes, one could lists JavaScript\index{PHP} here, too, but let's keep things simple and think of JavaScript as traditionally client-side here.] can now be done in R. This is not only convenient for the R developer who does not need to learn Java, it's also incredibly comfy if you got data work to do. Or put differently: who would like to implement logistic regression, random forests or principal component analysis in PHP?
...
![The {shinydashboard} R package provides nice, customizable skeletons for dashboards. (Source: screenshot of minimal, blank dashboard created with shinydashboard)](images/blank_dashboard.png)

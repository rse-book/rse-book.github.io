...
Now, that we installed the javascript framework expressjs, we can use the framework to create an minimal web application that serves an API endpoint using the node runtime environment. 

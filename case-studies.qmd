...
Advanced parallel implementations and deeper dives into the way how different processors can help to optimize efficiency here.

Yet, the key take away from the above exercise is not the parallel computation itself, but the ability to assess it. 
Benchmarking does not only help to get a ballpark estimate of the costs, it a gives you an idea whether the gains from a parallel approach are worth the hassle. 
...
Another good use of benchmarking is to run 

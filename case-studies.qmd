...
![The R Studio GUI is an easy way to create a key pair. (Source: screenshot RStudio IDE taken in 2021.)](images/rsa.png){fig-scap="Create a key pair with RStudio."}
...
![Cover illustration of the Hacking for Science Courses. (Source: own illustration.)](images/h4sci.png){fig-scap="Hacking for Science Course Series."}
...
![The KOF Swiss Economic Institute's media agenda in 2021. (Source: screenshot Google Chrome browser.)](images/agenda.png){fig-scap="KOF media agenda in 2021."}
...
![Modern browsers come with developer tools built in to help you expect a website's source code. (Source: screenshot Google Chrome browser.)](images/inspect.png){fig-scap="Google Chrome developer tools."}
...
![Browser tools help you explore the hierarchical structure of a website in interactive fashion. (Source: screenshot Google Chrome browser.)](images/xpath.png){fig-scap="xpath of a website."}
...
![Screenshot of an interactive choropleth; for the actual, interactive visualization visit https://rse-book.github.io/case-studies.html#sec-map](images/case-choropleth.png){fig-scap="Choropleth example."}
...
![Maybe I am late, but I look goood. Johnny representing the frontend. (Source: own illustration.)](images/johnny.png){fig-scap="Frontends are made to look spiffy."}
...
![While the frontend is busy looking spiffy, the backend does the computation work. (Source: own illustration.)](images/overload.jpg){fig-scap="Backends typically do the computation work."}
...
![The {shinydashboard} R package provides customizable skeletons for dashboards. (Source: screenshot of a blank dashboard created with shinydashboard.)](images/blank_dashboard.png){fig-scap="The shinydashboards R package."}
...
![GitHub's web platform offers swim lanes to keep a better overview of issues being worked on. (Source: own GitHub repository.)](images/swim.png){fig-scap="Swim Lanes."}
...
#| fig-scap: "Comparison of computation time"
library(ggplot2)
library(viridis)
vizframe <- d[,c(1,5)]
